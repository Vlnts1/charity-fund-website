      ...
      {isLoading ? (
        ...
        <Container className="containerabout">
          ...
          <Row className="mission">
            <Col>
              <h4 className="missiontext">
                Місія фонду – розвиток благодійності та волонтерства, становлення відповідального і
                толерантного суспільства в Україні та допомога тим, хто найбільш цього потребує.
              </h4>
            </Col>
          </Row>
